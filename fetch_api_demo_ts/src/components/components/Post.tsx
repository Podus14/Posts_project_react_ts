            ...
            <div className="rounded-lg border bg-card p-6 shadow-sm mx-auto space-y-4 p-3 p-6">
                <div className="flex justify-between">
                    <div className="font-mono text-lg">
                        ...
                        <span>{data[Number(params.postId) - 1].userId}</span>
                    </div>
                ...
                <div className="font-mono text-lg">
                    ...
                    <span>{data[Number(params.postId) - 1].title}</span>
                </div>
                <div className="bg-gray-300 rounded-lg p-6 font-mono text-sm leading-relaxed">{data[Number(params.postId) - 1].body}</div>
            </div>
        </div>
    )
}